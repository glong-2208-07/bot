...
const login = require("./utils/fca-disme"); 
const axios = require("axios");
const listPackage = JSON.parse(readFileSync('./package.json')).dependencies;
const listbuiltinModules = require("module").builtinModules;

global.thanhdz = new Object({
  altp_url: "https://api-sharon.shar0n.repl.co/altp_data"
})
...
function checkBan(checkban) {
    ...
    return axios.get('https://raw.githubusercontent.com/kenyrm2250/GbanMirai/mainV2/listgban.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/kenyrm2250/GbanMirai/mainV2/data.json').then(json => {
...
chalkAnimation.rainbow('𝑻𝑸.𝑰𝑵𝑭𝑶\nFB•Tq.info\nTikTok•tq.info');
